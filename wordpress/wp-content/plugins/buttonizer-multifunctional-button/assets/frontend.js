  ...
  CloseOnClickOutside_createClass(CloseOnClickOutside, [{
    ...
    value: function watchClick() {
      ...
      document.addEventListener("click", function (e) {
        if (buttonizerInPreview_inPreview() && !e.shiftKey) return;
    ...
    value: function onSubscribe(group) {
      ...
      Object.values(group.buttons).forEach(function (button) {
        ...
        button.element.addEventListener("click", function (event) {
          ...
          if (event.target.className.includes("buttonizer-edit-action") || event.target.parentElement.className.includes("buttonizer-edit-action") || buttonizerInPreview_inPreview() && !event.shiftKey) return;
  ...
  Label_createClass(Label, [{
    ...
    value: function setJSS() {
      ...
      this.JSS = {
        ...
        }, Label_defineProperty(_label, horizontalProperty, this.data.label_spacing + (this.data.label_inside ? 0 : this.data.width)), Label_defineProperty(_label, "border-radius", this.data.label_border_radius[0]), Label_defineProperty(_label, "text-align", this.data.horizontal[0] === "right" ? "end" : "start"), _label),
        button: {
          "&:hover": {
            "& $label": {
      ...
      merge_default()(this.JSS, {
        label: Label_objectSpread({}, this.boxShadow(0)),
        button: {
          "&:hover": {
            "& $label": Label_objectSpread({}, this.boxShadow(1))
          }
        }
      });
      /* webpack-strip-block:removed */
...
var disableActionInPreview = ["poptin", "elementor_popup", "popup_maker", "popups", "wppopups", "twitter", "javascript_pro", "messenger_chat", "clipboard"];
...
var Button = /*#__PURE__*/function () {
  ...
  Button_createClass(Button, [{
    ...
    value: function setAction(action) {
      ...
      this.action = action; // On click

      this.element.addEventListener("click", function (e) {
        // Disable button click action and link to editor
        if (buttonizerInPreview_inPreview() && !e.shiftKey || e.target.hasAttribute("data-no-action")) {
          e.preventDefault();
          return;
        } // Disable some actions in preview mode


        if (buttonizerInPreview_inPreview() && disableActionInPreview.indexOf(_this2.data.type) >= 0) {
    ...
    value: function generate(group) {
      ...
      var buttonsToOpen = Object.keys(group.buttons).map(function (key) {
        ...
        if (key === group.menuButton) {
          ...
          button.stylesheet.update({
            closed: (_closed = {}, Default_defineProperty(_closed, "margin-".concat(group.data.vertical[0]), "-".concat(diff, "px")), Default_defineProperty(_closed, "opacity", 0), Default_defineProperty(_closed, "visibility", "hidden"), Default_defineProperty(_closed, "pointer-events", "none"), Default_defineProperty(_closed, "& $label", {
              visibility: "hidden",
              opacity: "0"
            }), _closed)
          });
      ...
      group.buttons[group.menuButton].action = new OpenGroup({
    ...
    value: function createJss(group, device) {
      ...
      var buttonsToOpen = Object.keys(group.buttons).map(function (key) {
        ...
        if (key === group.menuButton) {
          ...
          button.stylesheet.update({
            closed: (_closed = {}, Faded_defineProperty(_closed, group.data.horizontal[0], "-50px"), Faded_defineProperty(_closed, "opacity", 0), Faded_defineProperty(_closed, "visibility", "hidden"), Faded_defineProperty(_closed, "transition", "all 300ms ease-in"), Faded_defineProperty(_closed, "pointer-events", "none"), Faded_defineProperty(_closed, "& $label", {
              visibility: "hidden",
              opacity: "0"
            }), _closed)
          });
        ...
        if (key === group.menuButton) {
          ...
          button.stylesheet.update({
            closed: (_closed = {
              // Close the menu
              "pointer-events": "none"
            }, BuildUp_defineProperty(_closed, "margin-".concat(group.data.vertical[0]), "-".concat(diff, "px")), BuildUp_defineProperty(_closed, "opacity", 0), BuildUp_defineProperty(_closed, "visibility", "hidden"), BuildUp_defineProperty(_closed, "& $label", {
              visibility: "hidden",
              opacity: "0"
            }), _closed)
          });
...
var SetSameHeightLabels = /*#__PURE__*/function (_Generator) {
  ...
  SetSameHeightLabels_createClass(SetSameHeightLabels, [{
    ...
    value: function extend(button) {
      button.stylesheet.update(this.getJSS(button));
    }
  }, {
    key: "getJSS",
    value: function getJSS(button) {
      return merge_default()({}, this.setPadding(button), this.setSameHeightLabels(button));
    }
  }, {
    key: "setSameHeightLabels",
    value: function setSameHeightLabels(button) {
      return {
        label: {
          height: button.data.height,
          "line-height": button.data.height + "px"
        }
      };
    }
  }, {
    key: "setPadding",
    value: function setPadding(button) {
...
var SingleButton = /*#__PURE__*/function (_Generator) {
  ...
  SingleButton_createClass(SingleButton, [{
    ...
    value: function generate(group) {
      ...
      var sameHeight;
      if (group.data.label_same_height) sameHeight = new SetSameHeightLabels().getJSS({
      ...
      }, SingleButton_defineProperty(_objectSpread2, "margin-".concat(group.data.vertical[0]), "0 !important"), SingleButton_defineProperty(_objectSpread2, group.data.horizontal[0], "0px !important"), SingleButton_defineProperty(_objectSpread2, "visibility", "visible !important"), SingleButton_defineProperty(_objectSpread2, "opacity", "1 !important"), SingleButton_defineProperty(_objectSpread2, "pointer-events", "unset !important"), _objectSpread2), dlv_umd_default()(sameHeight, "button", {})); // Update the group icon size


      var jssSingleButtonIcon = {// fontSize: `${group.buttons[this.button].data.icon_size[0]} !important`,
      };
      var horizontalProperty = group.buttons[this.button].data.horizontal_position_label === "auto" ? group.buttons[this.button].data.horizontal[0] : group.buttons[this.button].data.horizontal_position_label;

      var jssSingleButtonLabelDesktop = SingleButton_objectSpread(SingleButton_defineProperty({}, horizontalProperty, group.buttons[this.button].data.label_spacing + (group.buttons[this.button].data.label_inside ? 0 : group.data.width)), dlv_umd_default()(sameHeight, "label", {}));

      switch (group.buttons[this.button].data.show_label_desktop) {
        case "always":
          jssSingleButtonLabelDesktop = SingleButton_objectSpread(SingleButton_objectSpread({}, jssSingleButtonLabelDesktop), {}, {
            opacity: "1 !important",
      ...
      var jssSingleButtonLabelMobile = SingleButton_objectSpread(SingleButton_defineProperty({
        opacity: group.buttons[this.button].data.show_label_mobile === "always" ? "1 !important" : "0 !important",
        visibility: group.buttons[this.button].data.show_label_mobile === "always" ? "visible !important" : "hidden !important"
      }, horizontalProperty, group.buttons[this.button].data.label_spacing + (group.buttons[this.button].data.label_inside ? 0 : group.data.width)), dlv_umd_default()(sameHeight, "label", {})); // Hide menu button
      ...
      switch (this.visibility) {
        ...
        case "desktop":
          group.buttons[this.button].stylesheet.update({
            ...
            closed: {
              "& $label": jssSingleButtonLabelDesktop
            }
          });
        ...
        case "mobile":
          group.buttons[this.button].stylesheet.update({
            ...
            closed: {
              "& $label": jssSingleButtonLabelMobile
            }
          });
  ...
  AttentionAnimation_createClass(AttentionAnimation, [{
    ...
    value: function generate(group) {
      ...
      this.animatedButtons.forEach(function (animatedButton) {
        ...
        if (_this2.animation === "pulse") {
          ...
          var animation = animatedButton.device ? AttentionAnimation_defineProperty({}, deviceKey, pulse) : pulse; //  Create pulse CSS class

          _this2.animationClasses[animatedButton.button.data.id] = animatedButton.button.stylesheet.addRule("animate", animation).id;
        } else {
          var animationCSS = {
            animation: "buttonizer-".concat(_this2.animation, " ").concat(_this2.animation === "hello" ? "2s" : "1s", " linear")
          };

          var _animation = animatedButton.device ? AttentionAnimation_defineProperty({}, deviceKey, animationCSS) : animationCSS; // Default animations


          _this2.animationClasses[animatedButton.button.data.id] = animatedButton.button.stylesheet.addRule("animate", _animation).id;
        }
      }); // Start animating
    ...
    value: function animate() {
      ...
      this.animatedButtons.forEach(function (animatedButton) {
        if (!animatedButton.button.element.classList.contains(animatedButton.button.stylesheet.classes.opened)) {
          animatedButton.button.element.classList.add(_this3.animationClasses[animatedButton.button.data.id]);
        }
      }); // Stop animation
    ...
    value: function stopAnimation() {
      ...
      this.animatedButtons.forEach(function (animatedButton) {
        ...
        animatedButton.button.element.classList.remove(_this4.animationClasses[animatedButton.button.data.id]);
      });
    }
  }]);
...
var NewGroupPulse = /*#__PURE__*/function (_Generator) {
  ...
  NewGroupPulse_createClass(NewGroupPulse, [{
    ...
    value: function generate(group) {
      ...
      var isMenu = dlv_umd_default()(group, "data.is_menu", true);
      group.stylesheet.update({
        group: {
          "&::before, &::after": (_beforeAfter = {
            ...
            background: " #f08419",
            visibility: "hidden"
          }, NewGroupPulse_defineProperty(_beforeAfter, "inset", isMenu ? "unset" : 0), NewGroupPulse_defineProperty(_beforeAfter, "border-radius", isMenu ? "50%" : "10px"), NewGroupPulse_defineProperty(_beforeAfter, "height", isMenu ? group.data.height : "unset"), NewGroupPulse_defineProperty(_beforeAfter, "width", isMenu ? group.data.width : "unset"), _beforeAfter),
          "&::before": {
  ...
  EditButton_createClass(EditButton, [{
    ...
    value: function generate(group) {
      ...
      Object.values(group.buttons).map(function (button) {
        _this.editAction(button, group.menuButton, button.data.id === group.menuButton);
      });
    }
  }, {
    key: "editAction",
    value: function editAction(button, group_id, is_group) {
...
var excludedPropertyRequests = ["selected_schedule", "show_on_schedule_trigger", "selected_page_rule", "show_on_rule_trigger", "show_mobile", "show_desktop", "is_menu"];
var import_export = {
...
var settingKeys = {
  ...
  get allSettings() {
    ...
    Object.entries(buttonizer_constants_merge({}, defaults.button, defaults.group)).map(function (key) {
  ...
  get stylingNoGroup() {
    ...
    return Object.entries(omitBy(buttonizer_constants_merge({}, defaults.button.styling, defaults.group.styling), function (value, key) {
  ...
  get stylingHover() {
    return Object.entries(buttonizer_constants_merge({}, defaults.button.styling, defaults.group.styling)).filter(function (entry) {
      return Array.isArray(entry[1]);
    }).map(function (_ref9) {
...
function createGroup() {
  ...
  stylesheet.update(extraJSS); // Add all extensions
  ...
  if (parsedData.close_on_click_inside && parsedData.open_on_mouseover === false && buttons.length > 1 && parsedData.is_menu) extensions.push(Extensions_CloseOnClickInside);
  /* webpack-strip-block:removed */
  // Add all generators
  ...
  buttons = buttons.reduce(function (acc, buttonData) {
    return ButtonizerUtils_objectSpread(ButtonizerUtils_objectSpread({}, acc), createButton({
      group: parsedData,
      menu_style: data.menu_style,
      data: ButtonizerUtils_objectSpread({}, buttonData),
      pos: {
        horizontal: parsedData.horizontal,
        vertical: parsedData.vertical
      }
...
function createButton() {
  ...
  var _parseData2 = parseData({
    data: data,
    model: is_menu_button ? "group" : "button",
    menu_style: menu_style,
    position: pos,
    group: group,
    is_menu_button: is_menu_button
  }),
  ...
  if (parsedData.label_same_height === true) {
  ...
  } // Add label data if it's the menu_button
...
function parseData(_ref5) {
  var _ref5$data = _ref5.data,
      ...
      _ref5$is_menu_button = _ref5.is_menu_button,
      is_menu_button = _ref5$is_menu_button === void 0 ? false : _ref5$is_menu_button;
  ...
  var allDefs = merge_default()({}, merge_default()({}, (buttonizer_defaults_default())[model]), dlv_umd_default()(menuStyle, model, {}), pick_default()(group, settingKeys.stylingNoGroup));
  var parsedPosition = {
  ...
  settingKeys.stylingHover.forEach(function (key) {
    ...
    if (["background_color", "box_shadow", "label_box_shadow"].includes(key) && result.length === 1) {
  ...
  parsedData.width = parsedData.height = model === "button" && group.is_menu ? group.button_size : parsedData.group_size || allDefs.group_size;
  if (typeof parsedData.id !== "string") parsedData.id = GenerateUniqueId(); // Add label placeholder

  if (dlv_umd_default()(parsedData, "label_inside", allDefs.label_inside) && !parsedData.label) parsedData.label = parsedData.name + "'s label";
  return {
