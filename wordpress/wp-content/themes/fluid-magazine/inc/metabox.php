...
function fluid_magazine_save_sidebar_layout( $post_id ) { 
    global $fluid_magazine_sidebar_layout; 
    ...
    $layout = isset( $_POST['fluid_magazine_sidebar_layout'] ) ? sanitize_key( $_POST['fluid_magazine_sidebar_layout'] ) : 'right-sidebar';

    if( array_key_exists( $layout, $fluid_magazine_sidebar_layout ) ){
        update_post_meta( $post_id, 'fluid_magazine_sidebar_layout', $layout );
    }else{
        delete_post_meta( $post_id, 'fluid_magazine_sidebar_layout' );
    }
}
