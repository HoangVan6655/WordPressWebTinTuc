...
// register Fluid_Magazine_Popular_Post widget
function fluid_magazine_register_popular_post_widget() {
    register_widget( 'Fluid_Magazine_Popular_Post' );
}
add_action( 'widgets_init', 'fluid_magazine_register_popular_post_widget' );

if ( ! class_exists( 'Fluid_Magazine_Popular_Post' ) ): 
 /**
 * Adds Fluid_Magazine_Popular_Post widget.
 */
class Fluid_Magazine_Popular_Post extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'fluid_magazine_popular_posts', // Base ID
			esc_html__( 'RARA: Popular Post', 'fluid-magazine' ), // Name
			array( 'description' => esc_html__( 'A Popular Post Widget', 'fluid-magazine' ), ) // Args
		);
	}
...
} // class Fluid_Magazine_Popular_Post 
endif;